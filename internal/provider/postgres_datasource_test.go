        ...
        data "ubicloud_postgres" "testacc" {
          ...
          name = ubicloud_postgres.testacc.name
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ubicloud_postgres.testacc", "firewall_rules.#"),
					resource.TestCheckResourceAttrSet("data.ubicloud_postgres.testacc", "firewall_rules.0.cidr"),

...
func TestAccFirewallRuleDataSource(t *testing.T) {
	fwName := GetRandomResourceName("fw")
    ...
    `, GetTestAccProjectId(), GetTestAccLocation(), fwName)
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.ubicloud_firewall.testacc", "name", fwName),
					...
					resource.TestCheckResourceAttrSet("data.ubicloud_firewall_rule.testaccfwr1", "firewall_reference"),
					...
					resource.TestCheckResourceAttrSet("data.ubicloud_firewall_rule.testaccfwr2", "firewall_reference"),
					resource.TestCheckResourceAttr("data.ubicloud_firewall_rule.testaccfwr2", "cidr", "0.0.0.0/0"),
					resource.TestCheckResourceAttr("data.ubicloud_firewall_rule.testaccfwr2", "port_range", "22"),
				),
			},
		},
	})
